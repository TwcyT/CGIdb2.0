...
var mainbody_more_width = $('body').width() - 80;
var mainbody_less_width = $('body').width() - 260;
var home_describe_max = $('body').width() - 720;
var home_describe_min = $('body').width() - 820;
    //lsm-mini
    $('.lsm-mini-btn svg').on('click',function(){
        if ($('.lsm-mini-btn input[type="checkbox"]').prop("checked")) {
            ...
            $('.main-body').stop().animate({marginLeft : 60, width : mainbody_more_width},200);
            $('.home_highchart').stop().animate({paddingRight : 100},200);
            $('.home_describe').stop().animate({width : home_describe_max},200);

        }else{
            $('.left-side-menu').removeClass('lsm-mini');
            $('.lsm-container ul ul').css("display", "none");
            $('.left-side-menu').stop().animate({width: 240},200);
            $('.main-body').stop().animate({marginLeft : 240, width : mainbody_less_width},200);
            $('.home_highchart').stop().animate({paddingRight : 0},200);
            $('.home_describe').stop().animate({width : home_describe_min},200);
        }
